...
public class BookFactoryImpl implements BookFactory {
    ...
    @Autowired
    public BookFactoryImpl(DateFactory dateFactory, BookRepository bookRepository, ReadingRecordFactory readingRecordFactory, BookTypeFactory bookTypeFactory) {
